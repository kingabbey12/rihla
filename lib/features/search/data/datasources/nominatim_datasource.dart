...
class NominatimDatasource {
  ...
  Future<List<Map<String, dynamic>>> search(
    ...
    try {
      final response = await _client.get(uri, headers: _headers, cacheTtl: const Duration(minutes: 10));
  ...
  Future<Map<String, dynamic>?> lookup(String osmType, String osmId) async {
    ...
    try {
      final response = await _client.get(uri, headers: _headers, cacheTtl: const Duration(hours: 1));
